.class public Lcn/thinkingdata/core/router/ClassUtils;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/thinkingdata/core/router/ClassUtils;->SECONDARY_FOLDER_NAME:Ljava/lang/String;
...
.method public static getFileNameByPackageName(Landroid/content/Context;Ljava/lang/String;Lcn/thinkingdata/core/router/LogisticsCenter$OnLoadPluginCallBack;)V
    .locals 4

    invoke-static {p0}, Lcn/thinkingdata/core/router/ClassUtils;->getSourcePaths(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {}, Lcn/thinkingdata/core/utils/pool/DefaultPoolExecutor;->getInstance()Lcn/thinkingdata/core/utils/pool/DefaultPoolExecutor;

    move-result-object v2

    new-instance v3, Lcn/thinkingdata/core/router/ClassUtils$1;

    invoke-direct {v3, v0, p1, v1, p2}, Lcn/thinkingdata/core/router/ClassUtils$1;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/util/Set;Lcn/thinkingdata/core/router/LogisticsCenter$OnLoadPluginCallBack;)V
...
.method public static getSourcePaths(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {}, Lcn/thinkingdata/core/router/ClassUtils;->isVMMultidexCapable()Z

    move-result v3

    if-nez v3, :cond_1

    invoke-static {p0}, Lcn/thinkingdata/core/router/ClassUtils;->getMultiDexPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    sget-object v5, Lcn/thinkingdata/core/router/ClassUtils;->SECONDARY_FOLDER_NAME:Ljava/lang/String;
    ...
    :cond_1
    invoke-static {v0}, Lcn/thinkingdata/core/router/ClassUtils;->tryLoadInstantRunDexFile(Landroid/content/pm/ApplicationInfo;)Ljava/util/List;
...
.method private static isVMMultidexCapable()Z
    ...
    :try_start_0
    invoke-static {}, Lcn/thinkingdata/core/router/ClassUtils;->isYunOS()Z
