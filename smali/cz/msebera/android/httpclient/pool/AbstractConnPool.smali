...
.method private getPoolEntryBlocking(Ljava/lang/Object;Ljava/lang/Object;JLjava/util/concurrent/TimeUnit;Lcz/msebera/android/httpclient/pool/PoolEntryFuture;)Lcz/msebera/android/httpclient/pool/PoolEntry;
    ...
    .line 245
    :cond_3
    iget v2, p0, Lcz/msebera/android/httpclient/pool/AbstractConnPool;->validateAfterInactivity:I

    if-lez v2, :cond_4

    .line 246
    invoke-virtual {p4}, Lcz/msebera/android/httpclient/pool/PoolEntry;->getUpdated()J

    move-result-wide v2

    iget v4, p0, Lcz/msebera/android/httpclient/pool/AbstractConnPool;->validateAfterInactivity:I
    ...
    .line 247
    invoke-virtual {p0, p4}, Lcz/msebera/android/httpclient/pool/AbstractConnPool;->validate(Lcz/msebera/android/httpclient/pool/PoolEntry;)Z
    ...
    .line 254
    invoke-virtual {p3, p4, v0}, Lcz/msebera/android/httpclient/pool/RouteSpecificPool;->free(Lcz/msebera/android/httpclient/pool/PoolEntry;Z)V
    ...
    .line 306
    invoke-virtual {p6, v1}, Lcz/msebera/android/httpclient/pool/PoolEntryFuture;->await(Ljava/util/Date;)Z
