...
public class BatteryNotLowTracker extends BroadcastReceiverConstraintTracker<Boolean> {
    ...
    /* JADX DEBUG: Method merged with bridge method: getInitialState()Ljava/lang/Object; */
    ...
    public Boolean getInitialState() {
        ...
        return Boolean.valueOf(registerReceiver.getIntExtra(NotificationCompat.CATEGORY_STATUS, -1) == 1 || ((float) registerReceiver.getIntExtra(FirebaseAnalytics.Param.LEVEL, -1)) / ((float) registerReceiver.getIntExtra("scale", -1)) > BATTERY_LOW_THRESHOLD);
    }
