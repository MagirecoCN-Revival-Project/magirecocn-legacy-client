...
public final class LimitedDispatcher extends CoroutineDispatcher implements Runnable, Delay {
    ...
    public void mo1653scheduleResumeAfterDelay(long timeMillis, CancellableContinuation<? super Unit> continuation) {
        this.$$delegate_0.mo1653scheduleResumeAfterDelay(timeMillis, continuation);
    }
    ...
    */
            ...
            while (true) {
                ...
                if (i >= 16) {
                    ...
                    if (this.dispatcher.isDispatchNeeded(limitedDispatcher)) {
                        this.dispatcher.mo1652dispatch(limitedDispatcher, this);
                        return;
                    }
                }
            }
    ...
    public void mo1652dispatch(CoroutineContext context, Runnable block) {
        if (!addAndTryDispatching(block) && tryAllocateWorker()) {
            this.dispatcher.mo1652dispatch(this, this);
        }
    }
