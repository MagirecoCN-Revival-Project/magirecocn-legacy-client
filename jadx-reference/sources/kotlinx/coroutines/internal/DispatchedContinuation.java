...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(coroutineContext2)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo1652dispatch(coroutineContext2, this);
            return;
        }
    ...
    /* JADX DEBUG: Incorrect finally slice size: {[INVOKE, INVOKE, INVOKE, GOTO, INVOKE, INVOKE, INVOKE, GOTO, IF, INVOKE, INVOKE, IF] complete}, expected: {[INVOKE, INVOKE, INVOKE, INVOKE, INVOKE, INVOKE, IF, INVOKE, INVOKE, IF] complete} */
    ...
    public final void resumeCancellableWith(Object result, Function1<? super Throwable, Unit> onCancellation) {
        ...
        if (this.dispatcher.isDispatchNeeded(get$context())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo1652dispatch(get$context(), this);
            return;
        }
        DebugKt.getASSERTIONS_ENABLED();
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m116constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
                Continuation<T> continuation = this.continuation;
