...
public final class DispatchedContinuationKt {
    ...
    /* JADX DEBUG: Method not inlined, still used in: [kotlinx.coroutines.internal.DispatchedContinuation.<init>(kotlinx.coroutines.CoroutineDispatcher, kotlin.coroutines.Continuation<? super T>):void, kotlinx.coroutines.internal.DispatchedContinuation.takeState$kotlinx_coroutines_core():java.lang.Object] */
    ...
    /* JADX DEBUG: Incorrect finally slice size: {[IF, INVOKE, INVOKE, GOTO, IF, INVOKE, INVOKE, INVOKE, GOTO] complete}, expected: {[IF, INVOKE, INVOKE, IF, INVOKE, INVOKE, INVOKE] complete} */
    ...
    public static final <T> void resumeCancellableWith(Continuation<? super T> continuation, Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        if (dispatchedContinuation.dispatcher.isDispatchNeeded(dispatchedContinuation.get$context())) {
            ...
            dispatchedContinuation.dispatcher.mo1652dispatch(dispatchedContinuation.get$context(), dispatchedContinuation);
            return;
        }
