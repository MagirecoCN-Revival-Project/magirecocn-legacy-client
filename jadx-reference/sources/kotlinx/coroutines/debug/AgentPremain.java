...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m116constructorimpl = Result.m116constructorimpl(property == null ? null : Boolean.valueOf(Boolean.parseBoolean(property)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m116constructorimpl = Result.m116constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m122isFailureimpl(m116constructorimpl) ? null : m116constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m1629installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m1629installSignalHandler$lambda1(Signal signal) {
