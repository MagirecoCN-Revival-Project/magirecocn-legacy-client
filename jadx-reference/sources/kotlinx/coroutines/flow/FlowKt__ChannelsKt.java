...
public final /* synthetic */ class FlowKt__ChannelsKt {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:49:0x0056 */
            ...
            if (continuation instanceof FlowKt__ChannelsKt$emitAllImpl$1) {
                ...
                if ((flowKt__ChannelsKt$emitAllImpl$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        obj = receiveChannel.mo1605receiveCatchingJP2dKIU(flowKt__ChannelsKt$emitAllImpl$1);
                        ...
                        flowCollector = z2;
                        r9 = flowCollector2;
                        if (!ChannelResult.m1620isClosedimpl(obj)) {
                        }
                    } else if (i == 2) {
                        ...
                        try {
                            ...
                            if (!ChannelResult.m1620isClosedimpl(obj)) {
                                Throwable m1616exceptionOrNullimpl = ChannelResult.m1616exceptionOrNullimpl(obj);
                            ...
                            Object m1618getOrThrowimpl = ChannelResult.m1618getOrThrowimpl(obj);
                            ...
                            Object emit = r9.emit(m1618getOrThrowimpl, flowKt__ChannelsKt$emitAllImpl$1);
                            z4 = flowCollector;
                            flowCollector4 = r9;
