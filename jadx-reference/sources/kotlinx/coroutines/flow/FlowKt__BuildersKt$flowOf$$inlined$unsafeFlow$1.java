...
public final class FlowKt__BuildersKt$flowOf$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r9v5, resolved type: kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Multi-variable search result rejected for r9v6, resolved type: kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Multi-variable search result rejected for r9v8, resolved type: kotlinx.coroutines.flow.FlowCollector */
