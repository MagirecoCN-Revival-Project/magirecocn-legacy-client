...
public final class StateFlowImpl<T> extends AbstractSharedFlow<StateFlowSlot> implements MutableStateFlow<T>, CancellableFlow<T>, FusibleFlow<T> {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:56:0x0074 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:7:0x0025 */
