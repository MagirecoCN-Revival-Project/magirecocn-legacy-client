...
final class CombineKt$zipImpl$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:15:0x001b */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:2:0x000a */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:32:0x0018 */
    /* JADX DEBUG: Failed to insert an additional move for type inference into block B:8:0x0098 */
    /* JADX DEBUG: Type inference failed for r10v1. Raw type applied. Possible types: kotlin.jvm.functions.Function3<T1, T2, kotlin.coroutines.Continuation<? super R>, java.lang.Object>, kotlin.jvm.functions.Function3 */
    ...
    /* JADX DEBUG: Type inference failed for r5v3. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Type inference failed for r8v0. Raw type applied. Possible types: kotlinx.coroutines.flow.Flow<T2>, kotlinx.coroutines.flow.Flow */
    /* JADX DEBUG: Type inference failed for r9v1. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX DEBUG: Type inference failed for r9v2. Raw type applied. Possible types: kotlinx.coroutines.flow.FlowCollector<R>, kotlinx.coroutines.flow.FlowCollector */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    public static final class AnonymousClass2 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* compiled from: Combine.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0006\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003\"\u0004\b\u0002\u0010\u00042\u0006\u0010\u0005\u001a\u0002H\u0002H\u008a@¢\u0006\u0004\b\u0006\u0010\u0007"}, d2 = {"<anonymous>", "", "T1", "T2", "R", FirebaseAnalytics.Param.VALUE, "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 6, 0}, xi = 48)
        ...
        public static final class AnonymousClass1<T> implements FlowCollector, SuspendFunction {
            ...
            public static final class C00241 extends SuspendLambda implements Function2<Unit, Continuation<? super Unit>, Object> {
                ...
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                /* JADX WARN: Multi-variable type inference failed */
                C00241(ReceiveChannel<? extends Object> receiveChannel, FlowCollector<? super R> flowCollector, Function3<? super T1, ? super T2, ? super Continuation<? super R>, ? extends Object> function3, T1 t1, Continuation<? super C00241> continuation) {
                    super(2, continuation);
                    this.$second = receiveChannel;
                    this.$this_unsafeFlow = flowCollector;
                    this.$transform = function3;
                ...
                @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
                public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
                    return new C00241(this.$second, this.$this_unsafeFlow, this.$transform, this.$value, continuation);
                }
                ...
                */
                public final Object invokeSuspend(Object obj) {
                    Object mo1605receiveCatchingJP2dKIU;
                    ...
                    if (i == 0) {
                        ResultKt.throwOnFailure(obj);
                        this.label = 1;
                        mo1605receiveCatchingJP2dKIU = this.$second.mo1605receiveCatchingJP2dKIU(this);
                        if (mo1605receiveCatchingJP2dKIU == coroutine_suspended) {
                            return coroutine_suspended;
                        }
                    } else {
                        if (i != 1) {
                        ...
                        ResultKt.throwOnFailure(obj);
                        mo1605receiveCatchingJP2dKIU = ((ChannelResult) obj).getHolder();
                    }
                    FlowCollector flowCollector3 = this.$this_unsafeFlow;
                    if (mo1605receiveCatchingJP2dKIU instanceof ChannelResult.Failed) {
                        Throwable m1616exceptionOrNullimpl = ChannelResult.m1616exceptionOrNullimpl(mo1605receiveCatchingJP2dKIU);
                        if (m1616exceptionOrNullimpl == null) {
                            throw new AbortFlowException(flowCollector3);
                        }
                        throw m1616exceptionOrNullimpl;
                    }
                    Function3<T1, T2, Continuation<? super R>, Object> function3 = this.$transform;
                    T1 t1 = this.$value;
                    if (mo1605receiveCatchingJP2dKIU == NullSurrogateKt.NULL) {
                        mo1605receiveCatchingJP2dKIU = null;
                    }
                    this.L$0 = flowCollector3;
                    this.label = 2;
                    obj = function3.invoke(t1, mo1605receiveCatchingJP2dKIU, this);
                ...
                if (continuation instanceof CombineKt$zipImpl$1$1$2$1$emit$1) {
                    ...
                    if ((combineKt$zipImpl$1$1$2$1$emit$1.label & Integer.MIN_VALUE) != 0) {
                        ...
                        if (i != 0) {
                            ...
                            C00241 c00241 = new C00241(this.$second, this.$this_unsafeFlow, this.$transform, t1, null);
