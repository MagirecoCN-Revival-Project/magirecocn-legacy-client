...
final class CombineKt$combineInternal$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    /* JADX DEBUG: Duplicate block (B:34:0x0170) to fix multi-entry loop: BACK_EDGE: B:34:0x0170 -> B:7:0x016c */
    /* JADX DEBUG: Type inference failed for r10v10. Raw type applied. Possible types: kotlin.jvm.functions.Function0<T[]>, kotlin.jvm.functions.Function0 */
    /* JADX DEBUG: Type inference failed for r10v14. Raw type applied. Possible types: kotlin.jvm.functions.Function3<kotlinx.coroutines.flow.FlowCollector<? super R>, T[], kotlin.coroutines.Continuation<? super kotlin.Unit>, java.lang.Object>, kotlin.jvm.functions.Function3 */
    ...
    /* JADX WARN: Removed duplicated region for block: B:39:0x0118 A[EDGE_INSN: B:39:0x0118->B:25:0x0118 BREAK  A[LOOP:0: B:17:0x00f2->B:38:?], SYNTHETIC] */
    ...
    */
    public final Object invokeSuspend(Object obj) {
        ...
        if (i2 == 0) {
            ...
            b = r2;
            bArr = bArr2;
            indexedValue = (IndexedValue) ChannelResult.m1617getOrNullimpl(obj2);
            ...
            do {
                ...
                bArr[index] = b;
                indexedValue = (IndexedValue) ChannelResult.m1617getOrNullimpl(channel2.mo1606tryReceivePtdJZtk());
        ...
        obj2 = channel.mo1605receiveCatchingJP2dKIU(combineKt$combineInternal$2);
    ...
    public static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            try {
                if (i == 0) {
                    ...
                    int i2 = this.$i;
                    this.label = 1;
                    if (flowArr[i2].collect(new C00231(this.$resultChannel, i2), this) == coroutine_suspended) {
                        return coroutine_suspended;
                    }
                } else {
                    if (i != 1) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        /* compiled from: Combine.kt */
        @Metadata(d1 = {"\u0000\n\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0005\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u00032\u0006\u0010\u0004\u001a\u0002H\u0003H\u008a@¢\u0006\u0004\b\u0005\u0010\u0006"}, d2 = {"<anonymous>", "", "R", "T", FirebaseAnalytics.Param.VALUE, "emit", "(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 6, 0}, xi = 48)
        ...
        public static final class C00231<T> implements FlowCollector, SuspendFunction {
            ...
            C00231(Channel<IndexedValue<Object>> channel, int i) {
                this.$resultChannel = channel;
                this.$i = i;
            }
