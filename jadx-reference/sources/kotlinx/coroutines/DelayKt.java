...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo1653scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
        Object result = cancellableContinuationImpl.getResult();
        if (result == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
    ...
    public static final Object m1589delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m1590toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m1590toDelayMillisLRDsOJo(long j) {
        if (Duration.m1430compareToLRDsOJo(j, Duration.INSTANCE.m1533getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1449getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
