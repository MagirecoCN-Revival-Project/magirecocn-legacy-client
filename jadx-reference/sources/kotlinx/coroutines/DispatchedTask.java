        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m116constructorimpl(successfulResult$kotlinx_coroutines_core));
                }
                ...
                handleFatalException(null, Result.m119exceptionOrNullimpl(m116constructorimpl2));
            } finally {
            ...
            try {
                ...
                m116constructorimpl = Result.m116constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m119exceptionOrNullimpl(m116constructorimpl));
        }
    }
