...
public interface SendChannel<E> {
    ...
    Object mo1607trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo1607trySendJP2dKIU = sendChannel.mo1607trySendJP2dKIU(e);
            if (ChannelResult.m1622isSuccessimpl(mo1607trySendJP2dKIU)) {
                return true;
            }
            Throwable m1616exceptionOrNullimpl = ChannelResult.m1616exceptionOrNullimpl(mo1607trySendJP2dKIU);
