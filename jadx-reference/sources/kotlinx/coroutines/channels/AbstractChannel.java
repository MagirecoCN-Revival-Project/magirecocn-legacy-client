...
public abstract class AbstractChannel<E> extends AbstractSendChannel<E> implements Channel<E> {
    ...
    */
    public final Object mo1605receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
            ...
            if ((abstractChannel$receiveCatching$1.label & Integer.MIN_VALUE) != 0) {
                ...
                if (i != 0) {
                    ...
                    if (pollInternal != AbstractChannelKt.POLL_FAILED) {
                        return pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1625closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1627successJP2dKIU(pollInternal);
                    }
    ...
    public final Object mo1606tryReceivePtdJZtk() {
        Object pollInternal = pollInternal();
        return pollInternal == AbstractChannelKt.POLL_FAILED ? ChannelResult.INSTANCE.m1626failurePtdJZtk() : pollInternal instanceof Closed ? ChannelResult.INSTANCE.m1625closedJP2dKIU(((Closed) pollInternal).closeCause) : ChannelResult.INSTANCE.m1627successJP2dKIU(pollInternal);
    }
    ...
    /* JADX DEBUG: Method merged with bridge method: cancel(Ljava/lang/Throwable;)Z */
    @Override // kotlinx.coroutines.channels.ReceiveChannel
    ...
    public void onCancelIdempotent(boolean wasClosed) {
        ...
        Object m1643constructorimpl$default = InlineList.m1643constructorimpl$default(null, 1, null);
        while (true) {
            ...
            if (!(prevNode instanceof LockFreeLinkedListHead)) {
                ...
                if (!prevNode.mo1651remove()) {
                    prevNode.helpRemove();
                } else {
                    m1643constructorimpl$default = InlineList.m1648plusFjFbRPM(m1643constructorimpl$default, (Send) prevNode);
                }
            } else {
                mo1604onCancelIdempotentListww6eGU(m1643constructorimpl$default, closedForSend);
                return;
            }
        }
    }
    ...
    private final <R> void tryStartBlockUnintercepted(Function2<Object, ? super Continuation<? super R>, ? extends Object> function2, SelectInstance<? super R> selectInstance, int i, Object obj) {
        ...
        if (!z) {
            if (i != 1) {
                ...
                UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1612boximpl(z ? companion.m1625closedJP2dKIU(((Closed) obj).closeCause) : companion.m1627successJP2dKIU(obj)), selectInstance.getCompletion());
                return;
            }
        }
        if (i == 0) {
        ...
        if (i == 1 && selectInstance.trySelect()) {
            UndispatchedKt.startCoroutineUnintercepted(function2, ChannelResult.m1612boximpl(ChannelResult.INSTANCE.m1625closedJP2dKIU(((Closed) obj).closeCause)), selectInstance.getCompletion());
        }
    }
            ...
            while (true) {
                ...
                if (pollInternal instanceof Closed) {
                    ...
                    if (closed.closeCause == null) {
                        ...
                        cancellableContinuationImpl.resumeWith(Result.m116constructorimpl(Boxing.boxBoolean(false)));
                    } else {
                        Result.Companion companion2 = Result.INSTANCE;
                        cancellableContinuationImpl.resumeWith(Result.m116constructorimpl(ResultKt.createFailure(closed.getReceiveException())));
                    }
    ...
    public static class ReceiveElement<E> extends Receive<E> {
        ...
        public final Object resumeValue(E value) {
            return this.receiveMode == 1 ? ChannelResult.m1612boximpl(ChannelResult.INSTANCE.m1627successJP2dKIU(value)) : value;
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.receiveMode != 1) {
                ...
                Result.Companion companion2 = Result.INSTANCE;
                cancellableContinuation2.resumeWith(Result.m116constructorimpl(ChannelResult.m1612boximpl(ChannelResult.INSTANCE.m1625closedJP2dKIU(closed.closeCause))));
            }
        }
    ...
    public static class ReceiveHasNext<E> extends Receive<E> {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public Symbol tryResumeReceive(E value, LockFreeLinkedListNode.PrepareOp otherOp) {
            Object tryResume = this.cont.tryResume(true, otherOp == null ? null : otherOp.desc, resumeOnCancellationFun(value));
            if (tryResume == null) {
                return null;
            }
            if (DebugKt.getASSERTIONS_ENABLED()) {
    ...
    public static final class ReceiveSelect<R, E> extends Receive<E> implements DisposableHandle {
        ...
        @Override // kotlinx.coroutines.channels.ReceiveOrClosed
        public void completeResumeReceive(E value) {
            CancellableKt.startCoroutineCancellable(this.block, this.receiveMode == 1 ? ChannelResult.m1612boximpl(ChannelResult.INSTANCE.m1627successJP2dKIU(value)) : value, this.select.getCompletion(), resumeOnCancellationFun(value));
        }
        ...
        public void resumeReceiveClosed(Closed<?> closed) {
            if (this.select.trySelect()) {
                ...
                if (i == 0) {
                    ...
                    CancellableKt.startCoroutineCancellable$default(this.block, ChannelResult.m1612boximpl(ChannelResult.INSTANCE.m1625closedJP2dKIU(closed.closeCause)), this.select.getCompletion(), null, 4, null);
                }
            }
        }
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r2v3, resolved type: kotlinx.coroutines.channels.AbstractChannel$ReceiveElement */
    /* JADX DEBUG: Multi-variable search result rejected for r2v5, resolved type: kotlinx.coroutines.channels.AbstractChannel$ReceiveElement */
    /* JADX DEBUG: Multi-variable search result rejected for r2v6, resolved type: kotlinx.coroutines.channels.AbstractChannel$ReceiveElement */
    /* JADX INFO: Access modifiers changed from: private */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    protected void mo1604onCancelIdempotentListww6eGU(Object list, Closed<?> closed) {
        if (list == null) {
            return;
        }
        ...
        Objects.requireNonNull(list, "null cannot be cast to non-null type java.util.ArrayList<E of kotlinx.coroutines.internal.InlineList>{ kotlin.collections.TypeAliasesKt.ArrayList<E of kotlinx.coroutines.internal.InlineList> }");
