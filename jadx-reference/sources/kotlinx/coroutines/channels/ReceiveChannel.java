...
public interface ReceiveChannel<E> {
    ...
    Object mo1605receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo1606tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object mo1606tryReceivePtdJZtk = receiveChannel.mo1606tryReceivePtdJZtk();
            if (ChannelResult.m1622isSuccessimpl(mo1606tryReceivePtdJZtk)) {
                return (E) ChannelResult.m1618getOrThrowimpl(mo1606tryReceivePtdJZtk);
            }
            Throwable m1616exceptionOrNullimpl = ChannelResult.m1616exceptionOrNullimpl(mo1606tryReceivePtdJZtk);
            if (m1616exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(m1616exceptionOrNullimpl);
        }
            ...
            if (continuation instanceof ReceiveChannel$receiveOrNull$1) {
                ...
                if ((receiveChannel$receiveOrNull$1.label & Integer.MIN_VALUE) != 0) {
                    ...
                    if (i != 0) {
                        ...
                        mo1605receiveCatchingJP2dKIU = receiveChannel.mo1605receiveCatchingJP2dKIU(receiveChannel$receiveOrNull$1);
                    ...
                    return ChannelResult.m1617getOrNullimpl(mo1605receiveCatchingJP2dKIU);
                }
            }
