    ...
    */
    protected void onActivityResult(int i, int i2, Intent intent) {
        ...
        if (i == 100 || i == 110) {
                    ...
                    if (resultReceiver == null) {
                        ...
                        if (intent != null) {
                            if (intent.getExtras() != null) {
                                ...
                                zzfb zza = zzba.zza(22, 2, newBuilder.build());
                                try {
                                    int zzd = zza.zzd();
                                    byte[] bArr = new byte[zzd];
                                    com.google.android.gms.internal.play_billing.zzbi zzz = com.google.android.gms.internal.play_billing.zzbi.zzz(bArr, 0, zzd);
                                    zza.zzq(zzz);
                                    zzz.zzA();
                                    makePurchasesUpdatedIntent.putExtra("FAILURE_LOGGING_PAYLOAD", bArr);
                                    makePurchasesUpdatedIntent.putExtra("INTENT_SOURCE", "LAUNCH_BILLING_FLOW");
                                } catch (IOException e) {
            ...
            int zza2 = com.google.android.gms.internal.play_billing.zzb.zza(intent, TAG);
            ResultReceiver resultReceiver2 = this.inAppMessageResultReceiver;
            if (resultReceiver2 != null) {
                resultReceiver2.send(zza2, intent != null ? intent.getExtras() : null);
            }
        } else {
