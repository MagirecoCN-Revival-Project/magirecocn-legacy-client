...
public class AsyncHttpClient {
    ...
    private static SchemeRegistry getDefaultSchemeRegistry(boolean z, int i, int i2) {
        ...
        schemeRegistry.register(new Scheme(Constants.SCHEME, socketFactory, i2));
    ...
    public void setSSLSocketFactory(SSLSocketFactory sSLSocketFactory) {
        this.httpClient.getConnectionManager().getSchemeRegistry().register(new Scheme(Constants.SCHEME, sSLSocketFactory, 443));
    }
