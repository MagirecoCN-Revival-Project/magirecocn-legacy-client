...
public final class zzdr {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static Object zzB(Object obj, int i, int i2, Object obj2, zzeg zzegVar) {
        if (obj2 == null) {
    ...
    public static void zzE(int i, List list, zzey zzeyVar, boolean z) throws IOException {
    ...
    public static void zzF(int i, List list, zzey zzeyVar) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        zzeyVar.zze(i, list);
    ...
    public static void zzK(int i, List list, zzey zzeyVar, boolean z) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
    ...
    public static void zzL(int i, List list, zzey zzeyVar, zzdp zzdpVar) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
    ...
    public static void zzN(int i, List list, zzey zzeyVar, boolean z) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
    ...
    public static void zzO(int i, List list, zzey zzeyVar, zzdp zzdpVar) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        for (int i2 = 0; i2 < list.size(); i2++) {
    ...
    public static void zzS(int i, List list, zzey zzeyVar, boolean z) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
    ...
    public static void zzT(int i, List list, zzey zzeyVar) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
        zzeyVar.zzG(i, list);
    ...
    public static void zzV(int i, List list, zzey zzeyVar, boolean z) throws IOException {
        if (list == null || list.isEmpty()) {
            return;
        }
    ...
    private static zzeg zzX(boolean z) {
        Class<?> cls;
        try {
        ...
        try {
            return (zzeg) cls.getConstructor(Boolean.TYPE).newInstance(Boolean.valueOf(z));
    ...
    public static int zzq(List list) {
        ...
        if (list instanceof zzcc) {
            ...
            i = 0;
            while (i2 < size) {
                int zze2 = zzccVar.zze(i2);
                i += zzbi.zzx((zze2 >> 31) ^ (zze2 + zze2));
                i2++;
            }
        } else {
            i = 0;
    ...
    public static int zzs(List list) {
        ...
        if (list instanceof zzcu) {
            ...
            i = 0;
            while (i2 < size) {
                long zze2 = zzcuVar.zze(i2);
                i += zzbi.zzy((zze2 >> 63) ^ (zze2 + zze2));
                i2++;
            }
        } else {
            i = 0;
