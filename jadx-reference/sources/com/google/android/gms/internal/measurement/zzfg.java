...
public final class zzfg extends BaseGmsClient<zzez> {
    public zzfg(Context context, Looper looper, BaseGmsClient.BaseConnectionCallbacks baseConnectionCallbacks, BaseGmsClient.BaseOnConnectionFailedListener baseOnConnectionFailedListener) {
    ...
    public final /* synthetic */ zzez createServiceInterface(IBinder iBinder) {
        if (iBinder == null) {
            return null;
        }
