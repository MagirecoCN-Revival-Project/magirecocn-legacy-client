...
public final class zzfh extends zzhi {
    ...
    private final zzfj zzaix;
    private final zzfj zzaiy;
    private final zzfj zzaiz;
    private final zzfj zzaja;
    private final zzfj zzajb;
    private final zzfj zzajc;
    private final zzfj zzajd;
    private final zzfj zzaje;
    private final zzfj zzajf;

    /* JADX INFO: Access modifiers changed from: package-private */
    public zzfh(zzgm zzgmVar) {
        super(zzgmVar);
        this.zzaiv = (char) 0;
        this.zzadu = -1L;
        this.zzaix = new zzfj(this, 6, false, false);
        this.zzaiy = new zzfj(this, 6, true, false);
        this.zzaiz = new zzfj(this, 6, false, true);
        this.zzaja = new zzfj(this, 5, false, false);
        this.zzajb = new zzfj(this, 5, true, false);
        this.zzajc = new zzfj(this, 5, false, true);
        this.zzajd = new zzfj(this, 4, false, false);
        this.zzaje = new zzfj(this, 3, false, false);
        this.zzajf = new zzfj(this, 2, false, false);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static /* synthetic */ long zza(zzfh zzfhVar, long j) {
        zzfhVar.zzadu = 12451L;
        return 12451L;
    }
    ...
    public static Object zzbl(String str) {
        if (str == null) {
            return null;
        }
        return new zzfk(str);
    ...
    public final void zza(int i, boolean z, boolean z2, String str, Object obj, Object obj2, Object obj3) {
        ...
        if (zzjx == null) {
            ...
            if (zzjx.isInitialized()) {
                if (i < 0) {
                    i = 0;
                }
                zzjx.zzc(new zzfi(this, i >= 9 ? 8 : i, str, obj, obj2, obj3));
                return;
            }
