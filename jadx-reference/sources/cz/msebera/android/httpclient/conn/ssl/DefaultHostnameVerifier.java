...
public final class DefaultHostnameVerifier implements HostnameVerifier {
    ...
    private static boolean matchIdentity(String str, String str2, PublicSuffixMatcher publicSuffixMatcher, boolean z) {
        if (publicSuffixMatcher != null && str.contains(TRouterMap.DOT) && !matchDomainRoot(str, publicSuffixMatcher.getDomainRoot(str2))) {
            return false;
        }
        ...
        if (indexOf != -1) {
            ...
            if (substring2.isEmpty() || str.endsWith(substring2)) {
                return (z && str.substring(substring.length(), str.length() - substring2.length()).contains(TRouterMap.DOT)) ? false : true;
            }
            return false;
        }
