...
public abstract class AbstractConnPool<T, C, E extends PoolEntry<T, C>> implements ConnPool<T, E>, ConnPoolControl<T> {
    ...
    private RouteSpecificPool<T, C, E> getPool(final T t) {
        ...
        RouteSpecificPool<T, C, E> routeSpecificPool2 = (RouteSpecificPool<T, C, E>) new RouteSpecificPool<T, C, E>(t) { // from class: cz.msebera.android.httpclient.pool.AbstractConnPool.1
            /* JADX DEBUG: Multi-variable search result rejected for r0v0, resolved type: cz.msebera.android.httpclient.pool.AbstractConnPool */
    ...
    public Future<E> lease(final T t, final Object obj, FutureCallback<E> futureCallback) {
        ...
        return new PoolEntryFuture<E>(this.lock, futureCallback) { // from class: cz.msebera.android.httpclient.pool.AbstractConnPool.2
            /* JADX DEBUG: Method merged with bridge method: getPoolEntry(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object; */
    ...
    /* JADX DEBUG: Multi-variable search result rejected for r10v2, resolved type: cz.msebera.android.httpclient.pool.RouteSpecificPool */
    /* JADX DEBUG: Multi-variable search result rejected for r7v0, resolved type: cz.msebera.android.httpclient.pool.AbstractConnPool<T, C, E extends cz.msebera.android.httpclient.pool.PoolEntry<T, C>> */
    ...
    /* JADX DEBUG: Method merged with bridge method: release(Ljava/lang/Object;Z)V */
    /* JADX DEBUG: Multi-variable search result rejected for r1v0, resolved type: cz.msebera.android.httpclient.pool.AbstractConnPool<T, C, E extends cz.msebera.android.httpclient.pool.PoolEntry<T, C>> */
    /* JADX WARN: Multi-variable type inference failed */
    @Override // cz.msebera.android.httpclient.pool.ConnPool
