...
public final class NTLMEngineImpl implements NTLMEngine {
    ...
    private static String stripDotSuffix(String str) {
        ...
        int indexOf = str.indexOf(TRouterMap.DOT);
    ...
    public static class Type3Message extends NTLMMessage {
        ...
        String getResponse() {
            ...
            addULong((i6 & 4) | (i6 & 128) | (i6 & 512) | (524288 & i6) | NTLMEngineImpl.FLAG_REQUEST_VERSION | (32768 & i6) | (i6 & 32) | (i6 & 16) | (NTLMEngineImpl.FLAG_REQUEST_128BIT_KEY_EXCH & i6) | (Integer.MIN_VALUE & i6) | (NTLMEngineImpl.FLAG_REQUEST_EXPLICIT_KEY_EXCH & i6) | (8388608 & i6) | (i6 & 1));
            addUShort(261);
            addULong(2600);
            addUShort(3840);
