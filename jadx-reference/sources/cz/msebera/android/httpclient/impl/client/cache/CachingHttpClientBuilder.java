    ...
    protected ClientExecChain decorateMainExec(ClientExecChain clientExecChain) {
        ...
        if (resourceFactory2 == null) {
            ...
            if (file == null) {
                ...
                return new CachingExec(clientExecChain, new BasicHttpCache(resourceFactory, httpCacheStorage3, cacheConfig, cacheKeyGenerator, httpCacheInvalidator), cacheConfig, createAsynchronousRevalidator);
            }
        }
        resourceFactory = resourceFactory2;
        httpCacheStorage = this.storage;
        HttpCacheStorage httpCacheStorage22 = httpCacheStorage;
        if (httpCacheStorage == null) {
        }
        HttpCacheStorage httpCacheStorage32 = httpCacheStorage22;
        ...
        return new CachingExec(clientExecChain, new BasicHttpCache(resourceFactory, httpCacheStorage32, cacheConfig, cacheKeyGenerator2, httpCacheInvalidator), cacheConfig, createAsynchronousRevalidator2);
    }
