...
public class HttpClientBuilder {
    ...
    public CloseableHttpClient build() {
        ...
        if (httpClientConnectionManager2 == null) {
            ...
            Registry build = RegistryBuilder.create().register(HttpHost.DEFAULT_SCHEME_NAME, PlainConnectionSocketFactory.getSocketFactory()).register(Constants.SCHEME, connectionSocketFactory).build();
        ...
        ClientExecChain backoffStrategyExec = (backoffManager == null || (connectionBackoffStrategy = this.connectionBackoffStrategy) == null) ? decorateProtocolExec : new BackoffStrategyExec(decorateProtocolExec, connectionBackoffStrategy, backoffManager);
