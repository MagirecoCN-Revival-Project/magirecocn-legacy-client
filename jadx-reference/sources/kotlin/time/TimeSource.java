...
public interface TimeSource {
    ...
    public static final class Monotonic implements TimeSource {
        ...
        public /* bridge */ /* synthetic */ TimeMark markNow() {
            return ValueTimeMark.m1569boximpl(m1568markNowz9LOYto());
        }

        /* renamed from: markNow-z9LOYto, reason: not valid java name */
        public long m1568markNowz9LOYto() {
            return MonotonicTimeSource.INSTANCE.m1563markNowz9LOYto();
        }
        ...
        public static final class ValueTimeMark implements TimeMark {
            ...
            public static final /* synthetic */ ValueTimeMark m1569boximpl(long j) {
                return new ValueTimeMark(j);
            }

            /* renamed from: constructor-impl, reason: not valid java name */
            public static long m1570constructorimpl(long j) {
                return j;
            }
            ...
            public static String m1579toStringimpl(long j) {
                return "ValueTimeMark(reading=" + j + ')';
            }

            public boolean equals(Object obj) {
                return m1572equalsimpl(this.reading, obj);
            }

            public int hashCode() {
                return m1576hashCodeimpl(this.reading);
            }

            public String toString() {
                return m1579toStringimpl(this.reading);
            }
            ...
            public /* bridge */ /* synthetic */ TimeMark mo1424minusLRDsOJo(long j) {
                return m1569boximpl(m1580minusLRDsOJo(j));
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: plus-LRDsOJo */
            public /* bridge */ /* synthetic */ TimeMark mo1425plusLRDsOJo(long j) {
                return m1569boximpl(m1581plusLRDsOJo(j));
            }
            ...
            public static long m1571elapsedNowUwyO8pc(long j) {
                return MonotonicTimeSource.INSTANCE.m1562elapsedFrom6eNON_k(j);
            }

            @Override // kotlin.time.TimeMark
            /* renamed from: elapsedNow-UwyO8pc */
            public long mo1423elapsedNowUwyO8pc() {
                return m1571elapsedNowUwyO8pc(this.reading);
            }

            /* renamed from: plus-LRDsOJo, reason: not valid java name */
            public static long m1578plusLRDsOJo(long j, long j2) {
                return MonotonicTimeSource.INSTANCE.m1561adjustReading6QKq23U(j, j2);
            }

            /* JADX DEBUG: Possible override for method kotlin.time.TimeMark.plus-LRDsOJo(J)Lkotlin/time/TimeMark; */
            /* renamed from: plus-LRDsOJo, reason: not valid java name */
            public long m1581plusLRDsOJo(long j) {
                return m1578plusLRDsOJo(this.reading, j);
            }

            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public static long m1577minusLRDsOJo(long j, long j2) {
                return MonotonicTimeSource.INSTANCE.m1561adjustReading6QKq23U(j, Duration.m1483unaryMinusUwyO8pc(j2));
            }

            /* JADX DEBUG: Possible override for method kotlin.time.TimeMark.minus-LRDsOJo(J)Lkotlin/time/TimeMark; */
            /* renamed from: minus-LRDsOJo, reason: not valid java name */
            public long m1580minusLRDsOJo(long j) {
                return m1577minusLRDsOJo(this.reading, j);
            }

            /* renamed from: hasPassedNow-impl, reason: not valid java name */
            public static boolean m1575hasPassedNowimpl(long j) {
                return !Duration.m1464isNegativeimpl(m1571elapsedNowUwyO8pc(j));
            }

            @Override // kotlin.time.TimeMark
            public boolean hasPassedNow() {
                return m1575hasPassedNowimpl(this.reading);
            }

            /* renamed from: hasNotPassedNow-impl, reason: not valid java name */
            public static boolean m1574hasNotPassedNowimpl(long j) {
                return Duration.m1464isNegativeimpl(m1571elapsedNowUwyO8pc(j));
            }

            @Override // kotlin.time.TimeMark
            public boolean hasNotPassedNow() {
                return m1574hasNotPassedNowimpl(this.reading);
            }
        }
    }
