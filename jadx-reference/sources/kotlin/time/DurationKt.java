...
public final class DurationKt {
    ...
    private static final long m1557timesmvk6XK0(int i, long j) {
        return Duration.m1469timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk */
    private static final long m1556timeskIfJnKk(double d, long j) {
        return Duration.m1468timesUwyO8pc(j, d);
    }
    ...
    */
    public static final long parseDuration(String str, boolean z) {
        ...
        long m1533getZEROUwyO8pc = Duration.INSTANCE.m1533getZEROUwyO8pc();
        ...
        if (str.charAt(i3) == 'P') {
            ...
            while (i4 < length) {
                if (str.charAt(i4) != 'T') {
                    ...
                    if (durationUnitByIsoChar == DurationUnit.SECONDS && indexOf$default > 0) {
                        ...
                        z4 = z8;
                        long m1467plusLRDsOJo = Duration.m1467plusLRDsOJo(m1533getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                        Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                        String substring3 = substring.substring(indexOf$default);
                        Intrinsics.checkNotNullExpressionValue(substring3, "this as java.lang.String).substring(startIndex)");
                        m1533getZEROUwyO8pc = Duration.m1467plusLRDsOJo(m1467plusLRDsOJo, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                    } else {
                        z4 = z8;
                        m1533getZEROUwyO8pc = Duration.m1467plusLRDsOJo(m1533getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                    }
                    z8 = z4;
            ...
            if (StringsKt.regionMatches(str, i3, "Infinity", 0, Math.max(length - i3, 8), true)) {
                m1533getZEROUwyO8pc = Duration.INSTANCE.m1531getINFINITEUwyO8pc();
            } else {
                boolean z9 = !z6;
                ...
                while (i3 < i) {
                    ...
                    if (indexOf$default2 > 0) {
                        ...
                        long m1467plusLRDsOJo2 = Duration.m1467plusLRDsOJo(m1533getZEROUwyO8pc, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                        Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                        String substring7 = substring4.substring(indexOf$default2);
                        Intrinsics.checkNotNullExpressionValue(substring7, "this as java.lang.String).substring(startIndex)");
                        m1533getZEROUwyO8pc = Duration.m1467plusLRDsOJo(m1467plusLRDsOJo2, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                        i3 = i3;
                        if (i3 < i) {
                        ...
                        m1533getZEROUwyO8pc = Duration.m1467plusLRDsOJo(m1533getZEROUwyO8pc, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                        z9 = z9;
                        str4 = str6;
                        durationUnit = durationUnitByShortName;
                        i = i;
        ...
        return z2 ? Duration.m1483unaryMinusUwyO8pc(m1533getZEROUwyO8pc) : m1533getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m1431constructorimpl(j << 1);
    }

    public static final long durationOfMillis(long j) {
        return Duration.m1431constructorimpl((j << 1) + 1);
    }

    public static final long durationOf(long j, int i) {
        return Duration.m1431constructorimpl((j << 1) + i);
    }
