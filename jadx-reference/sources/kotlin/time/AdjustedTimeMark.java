...
final class AdjustedTimeMark implements TimeMark {
    ...
    public long mo1423elapsedNowUwyO8pc() {
        return Duration.m1466minusLRDsOJo(this.mark.mo1423elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo1425plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1467plusLRDsOJo(this.adjustment, duration), null);
    }
}
